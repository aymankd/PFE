        ...
        <div class="row">
          <div class="col-12 col-lg-8 m-auto">
			...
			<div class="form-row mt-4">
                ...
                <div class="form-row mt-4">
                    <div class="col">
                      <input class="multisteps-form__input form-control" type="text" placeholder="Nom Logement"/>
                    </div>
                  </div>
                  <div class="form-row mt-4">
				  ...
				  <div class="form-group row">
				   ...
				   <div class="form-row mt-4">
				   <div class="col-12 col-sm-6">
					  <input class="form-control" type="number" placeholder="Nombre de piece" />
				   </div>
				   <div class="col-12 col-sm-6 mt-4 mt-sm-0">
					  <input class="form-control" type="number"  placeholder="Nombre de locataire" />
					  </div> 
                   </div>
				
				   <div class="form-row mt-4">
					  <input class="form-control" type="number" placeholder="Adresse" />
				   </div>

				   <div class="form-row mt-4">
				  <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" placeholder="Reglement"></textarea>
                  </div>
