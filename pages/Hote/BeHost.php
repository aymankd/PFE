          ...
          <div class="col-12 col-lg-8 m-auto">
            ...
            <div class="col-6">	
              ...
              <label class="form-check-label Xa">
                ...
                <div class="form-row mt-4">
                    <div class="col">
                      <input class="multisteps-form__input form-control" name="nomL" type="text" placeholder="Nom Logement"/>
                    </div>
                  </div>
                  <div class="form-row mt-4">
				  <textarea class="form-control" id="exampleFormControlTextarea1" name="Desc" rows="3" placeholder="Description"></textarea>
                  </div>
                  <div class="form-row mt-4">
				  ...
				  <div class="form-group row">
				   ...
				   <div class="form-row mt-4">
				    <div class="col-12 col-sm-6 mt-4 mt-sm-0">
					   <input class="form-control" name="nbrloc" type="number"  placeholder="Nombre de locataire" />
					  </div>
            <div class="col-12 col-sm-6 " id="PieceInput">
					   <input class="form-control" name="nbrP" type="number" placeholder="Nombre de piece" />
				    </div> 
          </div>
				
				   <div class="form-row mt-4">
					  <input class="form-control" type="text" name="AdrLo" placeholder="Adresse" />
				   </div>

				   <div class="form-row mt-4">
				    <textarea class="form-control" id="exampleFormControlTextarea1" name="Reg" rows="3" placeholder="Reglement"></textarea>
           </div>                  
