           ...
           <div class="row">
            ...
            <div class="col-lg-6 grid-margin stretch-card">
              ...
              <div id="map_lst" class="nav flex-column nav-pills map_lst" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                <a class="nav-link" id="a01" data-toggle="pill" href="#a01" role="tab" aria-controls="a01" aria-selected="true"> Préfecture de Marrakech         </a>
                <a class="nav-link" id="a02" data-toggle="pill" href="#a02" role="tab" aria-controls="a02" aria-selected="false">Province de Chichaoua           </a>
                <a class="nav-link" id="a03" data-toggle="pill" href="#a03" role="tab" aria-controls="a03" aria-selected="false">Province d'Al Haouz             </a>
                <a class="nav-link" id="a04" data-toggle="pill" href="#a04" role="tab" aria-controls="a04" aria-selected="false">Province d'El Kelaâ des Sraghna </a>
                <a class="nav-link" id="a05" data-toggle="pill" href="#a05" role="tab" aria-controls="a05" aria-selected="false">Province d'Essaouira            </a>
                <a class="nav-link" id="a06" data-toggle="pill" href="#a06" role="tab" aria-controls="a06" aria-selected="false">Province de Rehamna             </a>
                <a class="nav-link" id="a07" data-toggle="pill" href="#a07" role="tab" aria-controls="a07" aria-selected="false">Province de Safi                </a>
                <a class="nav-link" id="a08" data-toggle="pill" href="#a08" role="tab" aria-controls="a08" aria-selected="false">Province de Youssoufia          </a>
