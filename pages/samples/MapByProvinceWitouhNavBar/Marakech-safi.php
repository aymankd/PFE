           ...
           <div class="row">
            ...
            <div class="col-lg-6 grid-margin stretch-card">
              ...
              <div id="map_lst" class="nav flex-column nav-pills map_lst" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                <a class="nav-link" id="a01"  href="../SearshResult.php?rech=<?=$rech?>&LGTP=<?=$LGTP?>&RCMI=<?=$RCMI?>&RCMA=<?=$RCMA?>&region=Marrakech-Safi&province=Préfecture de Marrakech"         role="tab" aria-controls="a01" aria-selected="true"> Préfecture de Marrakech         </a>
