    ...
    <body>
        <div class="container-fluid">
            <div class="row justify-content-center">
                <div class="col-11 col-md-7 col-lg-6 col-xl-6 text-center p-0 mt-3 mb-2">
                    <div class="card px-0 pt-4 pb-0 mt-3 mb-3">
                        ...
                        <form id="msform">
                                ...
                                <div class="form-card">
                                    ...
                                    <label class="fieldlabels">Superficie: *</label>
                                        <input type="number" name="Superficie" placeholder="Superficie" />
                                                ...
                                                <div class="dropdown">
                                                    <button  class="dropbtn btn btn-default ">Equipment</button>
                                        ...
                                        <label class="fieldlabels">Nombre de piece: *</label>
                                            <input type="number" name="nbrPiece" placeholder="Nombre de piece" />
                                        </div>
                            ...
                            <fieldset>
                                <div class="form-card">
                                    ...
                                    <label class="fieldlabels">Images1: *</label>
                                        ...
                                        <input type="file" name="Images2" accept="image/*" />
                                        <label class="fieldlabels">Images3: *</label>
                                        <input type="file" name="Images3" accept="image/*" />
                                        <label class="fieldlabels">Images4: *</label>
                                        <input type="file" name="Images4" accept="image/*" />
                                        <label class="fieldlabels">Images5: *</label>
                                        <input type="file" name="Images5" accept="image/*" />
                            ...
                            <fieldset>
                                ...
                                </div> <input type="button" name="EnrFrm" class="next action-button" value="Submit" /> <input type="button" name="previous" class="previous action-button-previous" value="Previous" />
                            </fieldset>
                            <fieldset>
                                <div class="form-card">
                                    <div class="row">
